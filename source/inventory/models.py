...
class Rack(models.Model):
	rack_name = models.CharField(max_length=50, blank=True, null=True)
	rack_Category = models.ForeignKey(Category, on_delete=models.CASCADE, blank=True)
	rack_capacity = models.IntegerField(default='0', blank=True, null=True)
	rack_warehouse = models.ForeignKey(Warehouse, on_delete=models.CASCADE, blank=True)
	#product_name = models.ForeignKey(Products, on_delete=models.CASCADE, blank=True)
...
class Product_items_details(models.Model):
	...
	rack_name = models.ForeignKey(Rack, on_delete=models.CASCADE, blank=True)
